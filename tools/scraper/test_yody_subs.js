...
const urls = [
  'https://yody.vn/quan-short-kaki-nam',
  'https://yody.vn/ao-len-co-lo-nam',
  'https://yody.vn/ao-cardigan-nam',
  'https://yody.vn/ao-len-det-kim-nam'
];

async function testPaths() {
  console.log('Testing specific Yody sub-categories...');
