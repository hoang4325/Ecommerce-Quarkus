...
foreach ($service in $services) {
    ...
    Start-Process "cmd.exe" -ArgumentList "/c title $service & cd .\$service & mvn quarkus:dev"
}
...
Start-Process "cmd.exe" -ArgumentList "/c title api-gateway & cd .\api-gateway & mvn quarkus:dev"
